...
const _quickActions = [
  _QuickAction(icon: AppIcons.topic, label: 'Topical\nStudy'),
  _QuickAction(icon: AppIcons.dictionary, label: 'Dictionary', route: '/dictionary'),
  _QuickAction(icon: AppIcons.download, label: 'My\nVideos', route: '/videos/downloads'),
  _QuickAction(icon: AppIcons.bookmark, label: 'My\nQuestions', route: '/cbt/bookmarks'),
  _QuickAction(icon: AppIcons.library, label: 'My\nBooks', route: '/books/saved'),
];
